...
namespace Library_Management_System
{
    public partial class Fine : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Connection.ConnectionString = "data source= DESKTOP-12F2LC4\\SQLEXPRESS; database=LibraryDb;integrated security=True";
            ...
            if (textBox1.Text != "")
            {
                ...
                if (Data.Tables[0].Rows.Count>0)
                {
                    ...
                    //Connection.ConnectionString = "data source= DESKTOP-ERBJH3F; database=Library Management System;integrated security=True";
                    Connection4.ConnectionString = "data source= DESKTOP-12F2LC4\\SQLEXPRESS; database=LibraryDb;integrated security=True";
